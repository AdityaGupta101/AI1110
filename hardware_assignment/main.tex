...
\begin{document}
	...
	%\setlist[enumerate,1]{before=\renewcommand\theequation{\theenumi.\arabic{equation}}
		...
		\author{ Name -: Aditya Gupta
			
			Roll no -: BT22BTECH11001
		% <-this % stops a space
...
\begin{enumerate}
	...
	\item The next connection is XOR gate (7486 IC)  
	
	\item  A,B,C,D of the decoder (7447 IC) is connected with $Q_0$,$Q_1$,$Q_2$,$Q_3$ respectively 
	\begin{figure}[h]
	...
	\item All the independent parts should be connected with each other and then connected the power source
